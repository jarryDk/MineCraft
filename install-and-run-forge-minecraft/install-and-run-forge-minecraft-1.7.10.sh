#!/bin/bash
#uri :https://raw.githubusercontent.com/jarryDk/MineCraft/master/install-and-run-forge-minecraft/install-and-run-forge-minecraft-1.7.10.sh
#title :install-and-run-forge-minecraft-1.7.10.sh
#description :Install and run forge minecraft version 1.7.10
#author :Michael Bornholdt Nielsen
#date :20150119
#update : 20150130
#usage :/bin/bash install-and-run-forge-minecraft-1.7.10.sh
